...
- (void)takePicture:(CDVInvokedUrlCommand*)command
{
    ...
    [self.commandDelegate runInBackground:^{
        ...
        BOOL hasCamera = [SCUIImagePicker isSourceTypeAvailable:pictureOptions.sourceType];
        if (!hasCamera) {
...
{
    if([navigationController isKindOfClass:[SCUIImagePicker class]]){
        SCUIImagePicker* cameraPicker = (SCUIImagePicker*)navigationController;
...
+ (instancetype) createFromPictureOptions:(CDVPictureOptions*)pictureOptions;
{
    ...
    if (cameraPicker.sourceType == UIImagePickerControllerSourceTypeCamera) {
        ...
        cameraPicker.mediaTypes = [SCUIImagePicker availableMediaTypesForSourceType:cameraPicker.sourceType];
    } else {
